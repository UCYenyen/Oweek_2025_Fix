        ...
        <>
         <nav className="relative w-screen z-[10] h-[60px] sm:h-[113px] bg-[url('/elements/navbar/navbar.svg')] bg-cover bg-center flex items-center justify-between px-6 sm:px-8">
          ...
          <div className='items-center gap-4 flex'>
            <Link to="/" className="button-navbar p-1 sm:p-2 text-[12px] sm:text-xl rounded-full border-solid border-2 sm:px-6">Home</Link>
            <Link to="/about" className="button-navbar p-1 sm:p-2 text-[12px] sm:text-xl rounded-full border-solid border-2 sm:px-6">About</Link>
            <Link to="/schedule" className="button-navbar p-1 sm:p-2 text-[12px] sm:text-xl rounded-full border-solid border-2 sm:px-6">Schedule</Link>
            <Link to="/rules" className="button-navbar p-1 sm:p-2 text-[12px] sm:text-xl rounded-full border-solid border-2 sm:px-6">Rules</Link>
          </div>
        </nav>
