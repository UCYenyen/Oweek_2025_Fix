...
export default function Countdown() {
  ...
  return (
    <>
     {/* Countdown */}
          <div className="relative h-full z-20 grid grid-cols-4 gap-4 items-end mb-96 justify-center">
            {/* Days */}
            <div className="flex flex-col gap-4">
                ...
                <div className="count-down-text-card bg-blend-screen rounded-full w-[170px] 3xl:w-[240px]">
                  <h1 className="bg-gradient-to-b from-[#F5AC01] to-[#C03A00] bg-clip-text text-transparent font-bold text-center text-2xl 3xl:text-3xl">Days</h1>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="count-down-text-card bg-blend-screen rounded-full w-[170px] 3xl:w-[240px]">
                <h1 className="bg-gradient-to-b from-[#F5AC01] to-[#C03A00] bg-clip-text text-transparent font-bold text-center text-2xl 3xl:text-3xl">Hours</h1>
                </div>
            </div>
            {/* Minutes */}
            <div className="flex flex-col gap-4">
                ...
                <div className="count-down-text-card bg-blend-screen rounded-full w-[170px] 3xl:w-[240px]">
                  <h1 className="bg-gradient-to-b from-[#F5AC01] to-[#C03A00] bg-clip-text text-transparent font-bold text-center text-2xl 3xl:text-3xl">Minutes</h1>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="count-down-text-card bg-blend-screen rounded-full text-2xl w-[170px] 3xl:w-[240px]">
                <h1 className="bg-gradient-to-b from-[#F5AC01] to-[#C03A00] bg-clip-text text-transparent font-bold text-center text-2xl 3xl:text-3xl">Seconds</h1>
                </div>
            </div>
          </div>
    </>
