    ...
    events: [
      {
        ...
        tasks: [
          "Range waktu : 17 Agustus 2025 - 22 Agustus 2025",
          "Deadline: 22 Agustus 2025 23.59 WIB",
          "Ketentuan:",
          "Trainee WAJIB membuat video menyebutkan 7 competence Universitas Ciputra.",
          "Video wajib memperlihatkan minimal kepala hingga pundak Trainee.",
          "Menggunakan baju bebas BERKERAH, sopan, dan rapi (TIDAK BOLEH menggunakan pakaian yang sobek, tembus pandang, crop top, sleeveless (memperlihatkan lengan atas)",
      ...
      },
      {
        ...
        tasks: [
          ...
          "Deadline: 22 Agustus 2025 23.59 WIB",
          "Ketentuan:",
          "Trainee DIWAJIBKAN untuk membuat video kreatif menjelaskan IPE (Integrity, Professionalism, Entrepreneurship) menurut pandangan trainee pribadi.",
          "Berikan minimal 3 contoh penerapan pada masing-masing poin I, P, dan E sebagai mahasiswa dalam kehidupan perkuliahan selama 4 tahun.",
          "Dalam pengambilan video Trainee diwajibkan memperlihatkan bagian badan mulai dari kepala hingga pundak",
          "Sebelum menyebutkan IPE trainee WAJIB memperkenalkan diri (nama, nomor kelompok, nama kelompok, dan jurusan)",
          "Trainee DIWAJIBKAN menggunakan baju bebas BERKERAH sopan dan rapi (TIDAK BOLEH menggunakan baju yang tembus pandang, crop top, sleeveless (memperlihatkan lengan atas)",
          "Pengambilan video dilakukan dalam pencahayaan yang baik.",
          "Wajah harus kelihatan dengan jelas, tidak ditutup ataupun menggunakkan masker",
          "Video dikumpulkan di drive yang telah disediakan dengan membuat folder format Nama_NamaKelompok/No kelompok_IPE”",
        ],
      },
      {
        ...
        tasks: [
          ...
          "Deadline: 22 Agustus 2025 23.59 WIB",
          "Ketentuan:",
          "Trainee diwajibkan untuk membuat video menyanyikan lagu Hymne UC.",
          "Video wajib memperlihatkan minimal kepala hingga pundak Trainee.",
          "Menggunakan baju bebas BERKERAH, sopan, dan rapi (TIDAK BOLEH menggunakan pakaian yang sobek, tembus pandang, crop top, sleeveless(memperlihatkan lengan atas).",
          "Video wajib diambil dalam pencahayaan yang baik dan dengan latar polos.",
          "Wajah Trainee harus terlihat jelas dan tidak tertutup oleh apapun (contoh: masker, rambut).",
      ...
      },
      {
        ...
        tasks: [
          ...
          "Link Gform : <link menyusul>",
          "Trainee WAJIB follow akun media sosial sebagai berikut:",
          "Instagram @universitasciputra",
          "Instagram @oweekucs",
          "Instagram @uc.studentaffairs",
          "Instagram @uc_studentmentor",
          "TikTok @universitasciputra",
          "Subscribe Youtube @OWeekUCOfficial",
        ],
      },
      {
        ...
        tasks: [
          "Range waktu : 17 Agustus 2025 -  24 Agustus 2025",
          "Deadline: 24 Agustus 2025 23:59 WIB (Bukti dikumpulkan melalui Google form yang telah disediakan oleh PCD) (Jika sudah mengisi form, AMD diharap untuk checklist sheet dari PCD)",
          "Upload di akun Instagram pribadi (akun TIDAK BOLEH di private dan TIDAK BOLEH second account).",
          "Submit Bukti upload twibbon melalui Google Form yang telah disediakan",
          "Link Gform : LINK Menyusul",
          "Caption menggunakan bahasa yang sopan.",
          "Foto Twibbon WAJIB Menggunakan kemeja putih dan celana hitam sopan dan rapi (TIDAK BOLEH menggunakan baju yang tembus pandang, crop top, sleeveless (memperlihatkan lengan atas).",
          "WAJIB memposting foto individu pada slide pertama dengan twibbon GIF yang sudah disediakan.",
          "WAJIB memposting foto kelompok pada slide kedua dengan twibbon foto yang sudah disediakan. Foto kelompok WAJIB dilakukan secara OFFLINE.",
          "Ratio foto WAJIB sesuai dengan ukuran twibbon.",
          "Wajah harus kelihatan dengan jelas, tidak ditutup ataupun ketutupan twibbon.",
          "Foto diambil dengan posisi yang proporsional minimal setengah badan (pundak ke atas)",
          "Postingan WAJIB di keep hingga closing O-Week pada tanggal 7 September 2024",
          "Link Template Twibbon: LINK Menyusul",
        ],
      },
      {
        title: "Format Caption",
        tasks: [
          "Hi, I’m (Nama Lengkap) from (Asal Nama SMA). I’m joining (Jurusan ‘Angkatan) and I believe we can achieve goals with quality to inspire. (tuliskan minimal 1 kalimat alasan positif memilih UC, 1 kalimat mengenai harapan kalian untuk berkuliah di UC) @universitasciputra @oweekucs #LUMINATE #IgnitingDreamsCreatingLegacies #OweekUCS2025 #UCPeople #UniversitasCiputra",
      ...
      },
       {
        ...
        tasks: [
          ...
          "Deadline: saat registrasi di cek oleh SID",
          "Trainee akan diberikan template name tag oleh panitia.",
          "Trainee WAJIB mencantumkan foto diri sendiri (Trainee WAJIB mengenakan kemeja putih berkerah dan jas hitam, wajah terlihat jelas tanpa masker, dan rambut tidak menutupi telinga. Lalu, Trainee berpose Salam Entrepreneur) dalam template name tag sesuai ukuran yang disediakan.",
          "Trainee WAJIB mencetak name tag di art paper minimal 140 gsm atau kertas foto dengan ukuran 13,5 cm x 9,5 cm. Name tag dicetak dua sisi dan tidak boleh mencetak template name tag milik kelompok lain.",
          "Trainee WAJIB menulis nama lengkap, NIM, dan jurusan di name tag secara digital",
          "Trainee WAJIB mengisi Trainee Card secara digital dengan ketentuan sebagai berikut:",
          "A. Font: Times New Roman",
          "B. Ukuran Nama dan NIM : 12",
          "C. Ukuran Jurusan : 6",
          "Trainee WAJIB membawa dan memakai name tag selama kegiatan O-Week berlangsung.",
          "Link Template : <link menyusul>",
        ],
      },
      {
        ...
        tasks: [
          "Range waktu : 10 Agustus 2025 - 17 Agustus 2025",
          "Deadline: saat registrasi di cek oleh SID",
          "Trainee WAJIB mencetak tag nama untuk tumblr menggunakan template yang telah disediakan oleh panitia. Tag nama WAJIB dicetak pada kertas Art Paper dengan ukuran 21 cm x 4 cm.",
          "Trainee mengisi tag tumblr dengan format “Nomor Kelompok - Nama Lengkap”.",
          "Pada 17 Agustus, Trainee akan diberikan tumblr dan wajib menempelkan label tumblr pada botol.",
          "Pada day 1-6, Trainee wajib membawa tumblr dari starter kit O-Week yang akan diberikan dan wajib menempelkan label pada tumblr secara melingkar.",
          "Link Template : <link menyusul>",
        ],
      },
    ],
